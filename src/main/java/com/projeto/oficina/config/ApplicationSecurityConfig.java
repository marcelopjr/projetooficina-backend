...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				...
				.antMatchers(HttpMethod.GET, "/usuarios/checaremail").permitAll()
				.antMatchers(HttpMethod.GET, "/usuarios/checarcpf").permitAll()
				.antMatchers(HttpMethod.PUT, "/usuarios/solicitartrocadesenha").permitAll()
				.antMatchers(HttpMethod.GET, "/usuarios/validartrocadesenha").permitAll()
				.antMatchers(HttpMethod.PUT, "/usuarios/trocarsenha").permitAll()
